...
public class RicercaAziendaNomeSiSedeNo {
  ...
  @Test
  public void testRicercaAziendaNomeSiSedeNo() throws Exception {
    ...
    driver.findElement(By.name("nomeAzienda")).sendKeys("chuky");
