...
public class RegistraAziendaTestPartitaIvaNO {
  ...
  @Test
  public void testRegistraAziendaTestPno() throws Exception {
    ...
    driver.findElement(By.name("iva")).clear();
    driver.findElement(By.name("iva")).sendKeys("112014369251");
