...
public class RecuperaPasswordTest {
  ...
  @Test
  public void testRecuperaPassword() throws Exception {
    ...
    driver.findElement(By.name("username")).sendKeys("m.decicco");
    driver.findElement(By.name("username")).clear();
    ...
    driver.findElement(By.name("conferma")).sendKeys("Unisalerno");
