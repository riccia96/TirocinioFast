...
public class RegistraAziendaTestUsernameInUso{
  ...
  @Test
  public void testRegistraAziendaTestUserINUSO() throws Exception {
    ...
    driver.findElement(By.name("username")).sendKeys("informatic");
