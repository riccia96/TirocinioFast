...
public class RegistraAziendaTestPasswordNO {
  ...
  @Test
  public void testRegistraAziendaTestPassno() throws Exception {
    ...
    driver.findElement(By.name("password")).sendKeys("inf");
    driver.findElement(By.name("conferma")).clear();
    driver.findElement(By.name("conferma")).sendKeys("inf");
