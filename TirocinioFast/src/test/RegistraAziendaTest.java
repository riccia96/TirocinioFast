...
public class RegistraAziendaTest {
  ...
  @Test
  public void testRegistraAzienda() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Registrazione azienda'])[1]/following::form[1]")).click();
