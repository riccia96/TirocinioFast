...
public class RegistraAziendaTestPasswordNonCorrispondenti {
  ...
  @Test
  public void testRegistraAziendaTestPassnoCor() throws Exception {
    ...
    driver.findElement(By.name("conferma")).sendKeys("informaticSrl1");
